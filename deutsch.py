...
("brennen","brannte","gebrannt","sein/haben","a arde"),
("bringen","brachte","gebracht","haben","a aduce"),
("denken","dachte","gedacht","haben","a gandi"),
("erlöschen","erlosch","erloschen","sein/haben","a se stinge"),
("erschrecken","erschrack","erschrocken","haben","a se speria"),
("essen","aßß","gegessen","haben","a manca"),
("fahren","fuhr","gefahren","sein/haben","a merge"),
("fallen","fiel","gefallen","haben","a cadea"),
("fangen","fing","gefangen","haben","a prinde"),
("finden","fand","gefunden","haben","a gasi"),
("fliegen","flog","geflogen","sein/haben","a zbura"),
("fliehen","floh","geflohen","haben","a evada"),
("frieren","fror","gefroren","haben","a ingheta"),
("gebären","gebar","geboren","sein","a naste"),
("geben","gab","gegeben","haben","a da"),
("gehen","ging","gegangen","sein","a merge"),
("gelingen","gelang","gelungen","haben","a reusi"),
...
("kriechen","kroch","gekrochen","haben","a se tara"),
...
("reißen","riss","gerissen","haben","a rupe"),
...
("schleichen","schlich","geschlichen","haben","a se furisa"),
...
("stehen","stand","gestanden","haben","a sta in picioare"),
...
("ziehen","zog","gezogen","haben","a trage"),
]
